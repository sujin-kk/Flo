...
class LockerSavedAlbumRVAdapter() : RecyclerView.Adapter<LockerSavedAlbumRVAdapter.ViewHolder>() {
    ...
    private lateinit var mItemClickListener: LockerSavedAlbumRVAdapter.MyItemClickListener

    fun setMyItemClickListener(itemClickListener: LockerSavedAlbumRVAdapter.MyItemClickListener){
    ...
    override fun onCreateViewHolder(
        viewGroup: ViewGroup,
        viewType: Int
    ): LockerSavedAlbumRVAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: LockerSavedAlbumRVAdapter.ViewHolder, position: Int) {
